...
from gerador.april.enums import AttributeType
from gerador.april.enums import Class
from gerador.april.enums import PadMode
from gerador.april.fs import EventLogFile
from gerador.april.generation import label_to_targets
...
class Dataset(object):
    ...
    def binary_targets(self):
        """Return targets for anomaly detection; 0 = normal, 1 = anomaly, 2 = drift."""
        if self.classes is not None and len(self.classes) > 0:
            ...
            targets[targets >= Class.DRIFT] = Class.ANOMALY
            return targets
        return None
